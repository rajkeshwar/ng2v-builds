/**
  ...
  * License: MIT
  */
import { ApplicationRef, Attribute, ChangeDetectionStrategy, ChangeDetectorRef, Component, ComponentFactoryResolver, ContentChildren, Directive, ElementRef, EventEmitter, HostBinding, HostListener, Inject, Injectable, Injector, Input, IterableDiffers, NgModule, NgZone, OpaqueToken, Optional, Output, Pipe, QueryList, Renderer, Self, SkipSelf, TemplateRef, ViewChild, ViewChildren, ViewContainerRef, ViewEncapsulation, forwardRef, isDevMode } from '@angular/core';
...
let ColorLocale = class ColorLocale {
};
ColorLocale = __decorate$40([
    Injectable()
], ColorLocale);
class DefaultColorLocale {
    constructor() {
...
const RGB = /(rgb)a?\(\s*(\d{1,3})\s*,\s*(\d{1,3})\s*%?,\s*(\d{1,3})\s*%?(?:,\s*(\d+(?:\.\d+)?)\s*)?\)/;
const HSL = /(hsl)a?\(\s*(\d{1,3})\s*,\s*(\d{1,3})%\s*,\s*(\d{1,3})%\s*(?:,\s*(\d+(?:\.\d+)?)\s*)?\)/;
class Hsva {
    constructor(h, s, v, a) {
        this.h = h;
        this.s = s;
...
let Md2Colorpicker = class Md2Colorpicker {
    constructor(_element, overlay, _viewContainerRef, _renderer, _locale, _util, _control) {
        this._element = _element;
...
__decorate$39([
    ...
    __metadata$24("design:type", QueryList)
...
let Md2ColorSpectrum = class Md2ColorSpectrum {
    constructor(_locale, _util) {
        this._locale = _locale;
        this._util = _util;
...
Md2ColorSpectrum = __decorate$41([
    ...
    __metadata$25("design:paramtypes", [ColorLocale, ColorUtil])
], Md2ColorSpectrum);
...
Md2OptionModule = Md2OptionModule_1 = __decorate$46([
    NgModule({
...
Md2SelectModule = Md2SelectModule_1 = __decorate$44([
    NgModule({
...
Md2DataTableModule = Md2DataTableModule_1 = __decorate$43([
    NgModule({
 ...
 * @docs-internal
 */
let Md2DatepickerPanel = class Md2DatepickerPanel {
    constructor(_elementRef) {
        this._elementRef = _elementRef;
    }
    ngAfterContentInit() {
...
let Md2Calendar = class Md2Calendar {
    ...
    set startAt(value) { this._startAt = this._locale.parseDate(value); }
    /** The currently selected date. */
    get selected() { return this._selected; }
    set selected(value) { this._selected = this._locale.parseDate(value); }
    /** The minimum selectable date. */
    get minDate() { return this._minDate; }
    ;
    set minDate(date) { this._minDate = this._locale.parseDate(date); }
    /** The maximum selectable date. */
    get maxDate() { return this._maxDate; }
    ;
    set maxDate(date) { this._maxDate = this._locale.parseDate(date); }
    /**
...
Md2Calendar = __decorate$52([
    ...
    __metadata$32("design:paramtypes", [DateLocale, DateUtil])
], Md2Calendar);
...
let Md2MonthView = class Md2MonthView {
    ...
    _init() {
        ...
        let firstOfMonth = new Date(this.activeDate.getFullYear(), this.activeDate.getMonth(), 1, this.activeDate.getHours(), this.activeDate.getMinutes(), this.activeDate.getSeconds());
...
Md2MonthView = __decorate$53([
    ...
    __metadata$33("design:paramtypes", [DateLocale, DateUtil])
], Md2MonthView);
...
let Md2YearView = class Md2YearView {
    ...
    _setScrollTop() {
        setTimeout(() => {
            const scrollContainer = this._element.nativeElement;
...
Md2Clock = __decorate$55([
    ...
    __metadata$35("design:paramtypes", [DateLocale, DateUtil])
], Md2Clock);
...
Md2DatepickerModule = __decorate$48([
    NgModule({
        imports: [
            CommonModule,
            OverlayModule,
...
Md2DialogPortal = __decorate$57([
    Directive({ selector: '[md2DialogPortal]' }),
    __metadata$37("design:paramtypes", [TemplateRef, ViewContainerRef])
], Md2DialogPortal);
/**
...
Md2DialogContent = __decorate$57([
...
Md2DialogActions = __decorate$57([
...
Md2DialogModule = Md2DialogModule_1 = __decorate$57([
    NgModule({
...
Md2MenuTrigger = __decorate$61([
    ...
    __metadata$38("design:paramtypes", [ElementRef, Renderer])
], Md2MenuTrigger);
...
Md2MenuModule = Md2MenuModule_1 = __decorate$58([
    NgModule({
        imports: [CommonModule],
...
__decorate$62([
    ...
    __metadata$39("design:paramtypes", [TemplateRef])
], Md2Transclude.prototype, "md2Transclude", null);
Md2Transclude = __decorate$62([
...
Md2TabLabel = __decorate$62([
    Directive({ selector: '[md2-tab-label]' }),
    __metadata$39("design:paramtypes", [TemplateRef, Md2Tab])
], Md2TabLabel);
...
Md2TabsModule = Md2TabsModule_1 = __decorate$62([
    NgModule({
        imports: [CommonModule],
...
Md2TagsModule = Md2TagsModule_1 = __decorate$63([
    NgModule({
        imports: [CommonModule, FormsModule, Md2AutocompleteModule],
...
Md2ToastComponent = __decorate$64([
    Component({
        selector: 'md2-toast',
...
Md2ToastModule = Md2ToastModule_1 = __decorate$64([
    NgModule({
        imports: [CommonModule],
...
Md2Tooltip = __decorate$66([
    ...
    __metadata$42("design:paramtypes", [Overlay,
        ElementRef,
        ScrollDispatcher,
        ViewContainerRef,
        NgZone,
...
Md2TooltipComponent = __decorate$66([
    ...
    __metadata$42("design:paramtypes", [Dir, ChangeDetectorRef])
], Md2TooltipComponent);
...
Md2TooltipModule = Md2TooltipModule_1 = __decorate$65([
    NgModule({
...
let Md2TreeItem = class Md2TreeItem {
    constructor() {
...
let Md2TreeModule = Md2TreeModule_1 = class Md2TreeModule {
    static forRoot() {
        return {
...
Md2TreeModule = Md2TreeModule_1 = __decorate$67([
    NgModule({
        imports: [CommonModule],
